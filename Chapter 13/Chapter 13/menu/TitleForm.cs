...
namespace WinformsMenu
{
    public partial class Title : Form
    {
        ...
        private void ExerciseExecute(string ex)
        {
            ...
            {
                case "btnEx1":
                    exercise = new Chapter_13.Exercises.Exercise_1();
                    break;
                case "btnEx2":
                    exercise = new Chapter_13.Exercises.Exercise_2();
                    break;
                case "btnEx3":
                    exercise = new Chapter_13.Exercises.Exercise_3();
                    break;
                case "btnEx4":
                    exercise = new Chapter_13.Exercises.Exercise_4();
                    break;
                case "btnEx7":
                    exercise = new Chapter_13.Exercises.Exercise_7();
                    break;
                case "btnEx10":
                    exercise = new Chapter_13.Exercises.Exercise_10();
                    break;
                default:
                    Environment.Exit(0);
                    break;
