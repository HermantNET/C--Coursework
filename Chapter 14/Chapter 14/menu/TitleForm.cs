...
namespace WinformsMenu
{
    public partial class Title : Form
    {
        ...
        private void ExerciseExecute(string ex)
        {
            ...
            {
                case "btnEx1":
                    exercise = new Chapter_14.Exercises.Exercise_1();
                    break;
                case "btnEx2":
                    exercise = new Chapter_14.Exercises.Exercise_2();
                    break;
                case "btnEx3":
                    exercise = new Chapter_14.Exercises.Exercise_3();
                    break;
                case "btnEx7":
                    exercise = new Chapter_14.Exercises.Exercise_7();
                    break;
                case "btnEx8":
                    exercise = new Chapter_14.Exercises.Exercise_8();
                    break;
                default:
                    Environment.Exit(0);
                    break;
