...
namespace WinformsMenu
{
    public partial class Title : Form
    {
        ...
        private void ExerciseExecute(string ex)
        {
            ...
            {
                case "btnEx1":
                    exercise = new Chapter_12.Exercises.Exercise_1();
                    break;
                case "btnEx3":
                    exercise = new Chapter_12.Exercises.Exercise_3();
                    break;
                case "btnEx5":
                    exercise = new Chapter_12.Exercises.Exercise_5();
                    break;
                case "btnEx10":
                    exercise = new Chapter_12.Exercises.Exercise_10();
                    break;
                default:
                    Environment.Exit(0);
                    break;
